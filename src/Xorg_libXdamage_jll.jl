...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXdamage_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0aeada51-83db-5f97-b67e-184615cfc6f6"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXdamage; unsupported platform $(triplet(platform_key_abi()))")
else
